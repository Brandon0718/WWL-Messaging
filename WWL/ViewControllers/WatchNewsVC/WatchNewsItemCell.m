...
@implementation WatchNewsItemCell
...
-(void) configureCell:(OwnStreamModel*) item {
    ...
    self.img_thumb.layer.cornerRadius = 4.0f;
    ...
    [self.img_thumb sd_setImageWithURL:url
    ...
    NSError* error;
    self.img_news_type.image = [[FAKFontAwesome iconWithIdentifier:[NSString stringWithFormat:@"fa-%@", item.streamType.icon] size:20.0f error:&error] imageWithSize:self.img_news_type.frame.size];
